...
*/                        var sql = @"INSERT INTO DisplaySalaryDetails (EmpId, EmployeeCode,BasicSalary, HouseRent, Conveyance, OtherAllowance, ESI, Tax, PF, Others, Reimbursement, NetSalary, CreatedAt, UpdatedAt) 
        ...
        /*public decimal taxValue, pfValue, reimbursementValue;
        private decimal CalculateAdjustedSalary(SalaryDetails todoItem)
        {
            taxValue = todoItem.BasicSalary * todoItem.Tax / 100;
            pfValue = todoItem.BasicSalary * todoItem.PF / 100;
            reimbursementValue = todoItem.HasReimbursement ? todoItem.Reimbursement : 0;
            return todoItem.BasicSalary + todoItem.HouseRent + todoItem.Conveyance + todoItem.OtherAllowance - (todoItem.ESI + taxValue + pfValue + todoItem.Others) + reimbursementValue;
        }
*/

/*        /update salary employeebasic table/
